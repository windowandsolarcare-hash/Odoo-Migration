"""
==============================================================================
ZAPIER PHASE 3 - FLATTENED FOR "CODE BY ZAPIER"
==============================================================================
...
# ==============================================================================
# ZAPIER OUTPUT FORMAT
# ==============================================================================
# The output dictionary will be available to subsequent Zapier steps
output = main(input_data)

# ==============================================================================
# TEST SECTION (Commented out for Zapier deployment)
# ==============================================================================

if False and __name__ == "__main__":
    # Test data - Bev Hartin March 12 booking
    test_input_data = {
        'event_start_time': '2026-03-12T15:30:00.000000Z',
        'service_type_required': 'Windows Inside & Outside Plus Screens',
        'additional_notes': 'Test booking from Calendly',
        'invitee_email': 'dansyourrealtor@gmail.com',
        'invitee_name': 'Bev Hartin',
        'service_address': '29 Toscana Way E, Rancho Mirage, CA 92270'
    }
    
    print("\n" + "="*70)
    print("TESTING FLATTENED SCRIPT - BEV HARTIN BOOKING")
    print("="*70)
    print(f"Address: {test_input_data['service_address']}")
    print(f"Service: {test_input_data['service_type_required']}")
    print(f"Date/Time: {test_input_data['event_start_time']}")
    print(f"Notes: {test_input_data['additional_notes']}")
    print("="*70 + "\n")
    
    # Run the main function
    result = main(test_input_data)
    ...
    if result['success']:
        ...
        print(f"  Sales Order ID: {result.get('sales_order_id')}")
    else:
