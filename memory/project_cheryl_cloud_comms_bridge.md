...
## ★ ONE-WRITER for AGENT-MAIL-OUT.md (fix adopted 2026-09-18)
Cheryl's-cloud had two pushes REJECTED this week because **Lead wrote her out-file concurrently** (to mark ✅ ported), and Lead's CRLF conversion turned 2-line edits into 5,442-line unmergeable diffs. **FIX: Lead READS + PORTS her `AGENT-MAIL-OUT.md` but must NEVER WRITE it** — do not ✅-mark inside her file. Track "ported-through" on the Lead side instead (a baseline sha in `/c/Users/dj/cheryl_out_lastsha.txt`, and/or note it in fleet `AGENT_MAIL.md`). She is the SOLE writer of her out-file. See [[project_cheryl_cloud_profile]] (fix #3).
