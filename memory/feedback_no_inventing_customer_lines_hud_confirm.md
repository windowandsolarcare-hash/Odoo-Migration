...
metadata: 
  ...
  modified: 2026-09-23T14:32:00.641Z
---
...
**Why:** scale + trust. Every customer touch must be a standardized, DJ-approved flow, so it works the same every time across the whole business — not dependent on what a session happens to type.
