...
- [feedback_escalate_to_dj_sparingly.md](feedback_escalate_to_dj_sparingly.md) — ★ DJ 2026-09-09: reach DJ ONLY when really needed (decision only he can make / money / customer-facing / truly blocked); otherwise MAKE THE CALL + one-line report. Higher bar than the old "ask DJ directly" reflex; don't relitigate his calls.
