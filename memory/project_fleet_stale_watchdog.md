...
metadata: 
  ...
  modified: 2026-09-13T04:35:00.134Z
---
...
Verified: app boots clean (scheduler accepted the job); offline-ran the parser on the live roster (fresh roles pass, stale roles flagged, Cheryl excluded). Tune via `_FLEET_STALE_HOURS` + the add_job cron. See [[feedback_agent_mail_autowatch]], [[feedback_lead_roster_restamp]].
